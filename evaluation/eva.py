...
def batch_evalution(dataset, start_id, end_id, bs_true):
    ...
    print(f"original ref. summary vs. {model} summary:\n"
        ...
        f"bart": {eva_ori_lt5.total_bart / eva_ori_lt5.call_time_rs}\n")
    ...
    #     f"bart: {eva_ori_dis.total_bart / eva_ori_dis.call_time_rs}\n")
    ...
    #     f"bart: {eva_ori_gpt.total_bart / eva_ori_gpt.call_time_rs}\n")
    ...
    #     f"bart: {eva_ori_cot.total_bart / eva_ori_cot.call_time_rs}\n")
    ...
    print(f"element-aware ref. summary vs. {model} summary:\n"
        ...
        f"bart: {eva_ele_lt5.total_bart / eva_ele_lt5.call_time_rs}\n")
    ...
    #     f"bart: {eva_ele_dis.total_bart / eva_ele_dis.call_time_rs}\n")
    ...
    #     f"bart: {eva_ele_gpt.total_bart / eva_ele_gpt.call_time_rs}\n")
    ...
    #     f"bart: {eva_ele_cot.total_bart / eva_ele_cot.call_time_rs}\n")
